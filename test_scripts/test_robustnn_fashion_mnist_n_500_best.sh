...
data_dir='./data/'
output_dir_prefix="${data_dir}results_robustnn_fashion_mnist_best_${random_seed_id}/"
...
for primal_step_size in 0.03162 0.01 0.003162 0.001
do
    for dual_step_size in 1 0.3162 0.1 0.03162 0.01
    do
        python3 -m torch.distributed.launch --nproc_per_node=${num_nodes_double} \
            ./main_robustnn.py --master_addr='127.0.0.1' \
            --data_dir=${data_dir} \
