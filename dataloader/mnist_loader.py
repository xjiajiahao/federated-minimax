...
class FastMNIST(torchvision.datasets.MNIST):
    """The (multiclass) MNIST dataset (fast version).
...
class MNISTLoader(object):
    """The multiclass or binary MNIST dataset loader.
    ...
    def __init__(self, num_partitions, data_root='./data/', train_batch_size=32, test_batch_size=32, is_multiclass=False, pos_classes=[0], device='cpu', sort_by=None, similarity=0, image_size=None):
        ...
        self.train_set = FastMNIST(data_root=data_root,
                                            train=True,
    ...
    def build_test_loader(self):
        if self.test_set is None:
            self.test_set = FastMNIST(data_root=self.data_root,
                                              train=False,
                                            #   train=True,
                                              transform=self.transform,
                                              download=True,
...
def BuildFedMNISTDataset(num_partitions, data_root='./data/', sort_by=None, similarity=0):
    """Constructing the federated MNIST dataset.
    ...
    Arguments:
        ...
        similarity (float number in the range [0, 1]): the ratio of random partitioned data (default: 0, no similarity), only applicable to sort_by='label'
    """
    train_set = FastMNIST(data_root=data_root,
                                   train=True,
                                   download=True,
                                   device='cpu',
                                   sort_by=sort_by,
    ...
    test_set = FastMNIST(data_root=data_root,
                                          train=False,
                                        #   train=True,
                                          download=True,
                                          device='cpu')
    ...
    # save data files
    data_folder_name = 'fed_mnist_n_' + str(num_partitions) + '_sort_by_' + sort_by + '_sim_' + str(similarity)
...
class FedMNISTLoader(object):
    """The federated MNIST dataset loader.
